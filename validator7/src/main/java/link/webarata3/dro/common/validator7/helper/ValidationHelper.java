...
public class ValidationHelper {
     ...
     * コンストラクタ。
     *
     * @param trimType      Validationの前に行うTrimの方向
     * @param lineBreakType 正規化する改行の種類
     */
     ...
     * @throws IllegalArgumentException lengthに負数の指定
     */
     ...
     *
     * @param value        検査する文字列
     * @param useEmBlank   全角ブランクを許可するか
     * @param useLineBreak 改行を許可するか
